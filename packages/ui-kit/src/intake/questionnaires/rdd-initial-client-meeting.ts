...
/**
 * The RDD initial-client-meeting questionnaire (SESSION_0625, G-021 lane).
 *
 * ── Provenance ───────────────────────────────────────────────────────────────────────────────────
 ...
 */
export const RDD_INITIAL_CLIENT_MEETING: Questionnaire = {
  id: "rdd-initial-client-meeting",
