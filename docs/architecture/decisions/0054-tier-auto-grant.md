---
title: "ADR 0054 — Tier-Based Entitlement Auto-Grant via Stripe Webhook"
slug: adr-0054-tier-auto-grant
type: decision
status: accepted
created: 2026-05-11
updated: 2026-06-06
...
# ADR 0054 — Tier-Based Entitlement Auto-Grant via Stripe Webhook

> **Renumbered 2026-07-26 (SESSION_0711 sweep):** this ADR was minted as a duplicate `0012`
> (colliding with `0012-admin-crud-routing-pattern.md`). Renumbered to 0054 to restore a
> contiguous log. Content unchanged; older docs may still cite it as "ADR 0012 tier auto-grant".
