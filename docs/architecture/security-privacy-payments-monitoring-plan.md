...
- Refund/cancel/dispute/failed-renewal events revoke, expire, or grace entitlements according to a written policy. SESSION_0096 policy: failed renewal grants seven-day grace, paid renewal restores active access, full refund/dispute revoke Stripe-sourced access and suspend program enrollment projections.
