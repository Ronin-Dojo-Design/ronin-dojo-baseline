...
This next-session pointer was grilled and planned into a multi-session epic on 2026-05-31 (Petey). The cold/headless sessions **must read [`docs/petey-plan-0319.md`](../../../_archive/petey-plans/petey-plan-0319.md)** for the full S0319→S0320→S0321 decomposition and the locked decisions — they cannot grill. Locked (ratified by Brian):
