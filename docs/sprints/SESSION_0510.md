...
| SESSION_0510_TASK_07-item7 | pending | Ratify 4-axes rule + deny-behavior table in `auth.md` (lead, inline) |
| SESSION_0510_TASK_07 | pending | Authz security gate (tests-first, gated) |
