---
title: "SESSION 0406 — BBL go-live data: lineage pricing seed + Dirty Dozen profile import"
slug: session-0406
type: session--implement
status: in-progress
created: 2026-06-17
updated: 2026-06-17
last_agent: claude-session-0406
sprint: S6
pairs_with:
...
# SESSION 0406 — BBL go-live data: lineage pricing seed + Dirty Dozen profile import
...
Brian + claude-session-0406 (unattended cloud run)
...
#### SESSION_0406_TASK_01 — BBL lineage-membership pricing seed (Cody)
...
#### SESSION_0406_TASK_02 — Dirty Dozen profile import (Cody)
...
#### SESSION_0406_TASK_03 — Gates + PRs (Doug / Petey)
...
| ID | Status | Summary |
| --- | --- | --- |
| SESSION_0406_TASK_01 | landed | `seed-bbl-lineage-pricing.ts` (4 plans, env price ids, cumulative grants) + `BBL_STRIPE_PRODUCTS_SPEC.md`. |
| SESSION_0406_TASK_02 | landed | `import-bbl-lineage-profiles.ts` (7 placeholder Passports + DirectoryProfiles + Dirty Dozen visual group) + `BBL_LINEAGE_IMPORT_SPEC.md`. |
| SESSION_0406_TASK_03 | in-progress | Static gates + two draft PRs. |
...
| `docs/sprints/SESSION_0406.md` | This record. |
| `docs/knowledge/wiki/index.md` | SESSION_0406 row. |
