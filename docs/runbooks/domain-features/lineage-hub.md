...
- [ADR 0043 — RankAward fact vs member-owned RankMilestone](../../architecture/decisions/0043-rank-award-fact-vs-member-milestone.md) — Belt Journey story/media enrichment is 1:1 with `RankAward` and never owns rank authority.
