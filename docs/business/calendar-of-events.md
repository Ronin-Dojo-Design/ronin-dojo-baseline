---
title: Ronin Dojo Design — Calendar of Events
...
# Ronin Dojo Design — Calendar of Events

Chronological ledger of agency events (intakes, discovery calls, milestones). Each entry
links to its lead/engagement file.

> ⚠️ **Not a live calendar.** This is a repo record only — there is no external calendar
> integration in this environment. A human must mirror these into Google Calendar (or
> equivalent) to get an actual invite/reminder.
