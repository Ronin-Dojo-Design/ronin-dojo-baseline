# SOP — Agent Workflows, Bow In / Bow Out, and Protocol Folder Map (Baseline Repo)

## Purpose
Align the repo-native agent/ritual/protocol layer with the new baseline stack.

This is **not** the old RoninDashboard ritual machine.
This is the lighter, repo-native version.
