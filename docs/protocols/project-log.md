...
- [Rules (legacy)](../_archive/project-log/00-rules.md)
- [Build log SESSION_0003 – SESSION_0224](../_archive/project-log/01-build-log.md)
- [Task plan log SESSION_0021 – SESSION_0224](../_archive/project-log/02-task-plan-log.md)
- [Task review log SESSION_0114 – SESSION_0218](../_archive/project-log/03-task-review-log.md)
...
- [Hostile close review](hostile-close-review.md) — review entries go into the SESSION file, not here.
