...
] as const satisfies readonly TuffBuffsAffiliateGearProduct[]

export const tuffBuffsAffiliateGearCollections = [
  {
    id: "bjj",
    name: "BJJ",
...
] as const satisfies readonly TuffBuffsAffiliateGearCollection[]

const affiliateProductById = new Map<string, TuffBuffsAffiliateGearProduct>(
  tuffBuffsAffiliateGearProducts.map(product => [product.id, product]),
)

const isAffiliateGearProduct = (
...
export const getTuffBuffsAffiliateGearForProgram = (programKey: TuffBuffsProgramGearKey) =>
  tuffBuffsAffiliateGearProducts.filter(product =>
    (product.recommendedFor as readonly TuffBuffsProgramGearKey[]).includes(programKey),
  )
