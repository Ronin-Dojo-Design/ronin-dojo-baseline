 ...
 *
 * This is transaction-only core logic, not a client-callable Server Action. The
 * `server-only` boundary keeps its transaction argument out of the action export set.
 */
