...
const beltCardOutput = z.object({
   ...
   * True for member-authored STATED backfills, including their imported WP self-report;
   * false for instructor-stamped or disputed awards. The card renders read-only when false.
   */
