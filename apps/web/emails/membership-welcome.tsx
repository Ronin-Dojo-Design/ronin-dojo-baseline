    ...
    <EmailWrapper {...props} preview={preview}>
      {isActive ? (
        <>
          ...
          <Text>
            Your <strong>{disciplineName}</strong> membership in{" "}
            <strong>{organizationName}</strong> is now <strong>active</strong>. Welcome to the team.
          </Text>
        ...
        <>
          ...
          <Text>
            ...
            <strong>{disciplineName}</strong>. Your application is{" "}
            <strong>pending approval</strong> from the organization owner.
          </Text>
