...
import { EntitlementActions } from "~/app/admin/entitlements/_components/entitlement-actions"
...
export const getColumns = (): ColumnDef<EntitlementRow>[] => {
  return [
    ...
    },
    {
      ...
      cell: ({ row }) => (
        <DataTableLink href={`/admin/entitlements/${row.original.id}`} title={row.original.name} />
      ),
    },
    {
      accessorKey: "key",
