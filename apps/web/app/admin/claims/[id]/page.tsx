...
import { ProfileClaimReviewActions } from "./_components/profile-claim-review-actions"

/**
 * Admin profile-claim detail + review (SESSION_0354). Mirrors lineage claim detail.
 */

export default withAdminPage(async ({ params }: PageProps<"/admin/claims/[id]">) => {
  ...
  return (
    <Wrapper>
      <Stack direction="column" className="gap-6">
        <div>
          <Link href="/admin/claims" className="text-muted-foreground text-sm hover:underline">
            ← Back to Claims
          </Link>
          <Heading
