...
import { getColumns } from "~/app/admin/content/_components/content-atoms-table-columns"
import { ContentAtomsTableToolbarActions } from "~/app/admin/content/_components/content-atoms-table-toolbar-actions"
      ...
      <DataTableHeader
        ...
        callToAction={
          <Button
            ...
            size="md"
            prefix={<PlusIcon />}
            render={<Link href="/admin/content/new" />}
          >
