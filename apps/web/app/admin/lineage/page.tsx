...
async function LineageContent({
  ...
  searchParams: PageProps<"/admin/lineage">["searchParams"]
}) {
            ...
            {trees.map(tree => (
              ...
              >
                <Stack direction="column" size="xs" className="min-w-0">
                  <Link href={`/admin/lineage/${tree.id}`} className="truncate font-medium">
                    {tree.name}
                  </Link>
                  <Stack size="xs" wrap>
                ...
                <Stack size="xs" className="justify-end" wrap>
                  <Button
                    variant="secondary"
                    size="sm"
                    render={<Link href={`/admin/lineage/${tree.id}`} />}
                  >
                    Manage
                  </Button>
                  <Button
...
export default withLineageAdminPage(async ({ searchParams }: PageProps<"/admin/lineage">) => {
  return (
