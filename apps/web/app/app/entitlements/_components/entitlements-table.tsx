...
import {
  type EntitlementRow,
  getColumns,
} from "~/app/app/entitlements/_components/entitlements-table-columns"
import { EntitlementsTableToolbarActions } from "~/app/app/entitlements/_components/entitlements-table-toolbar-actions"
      ...
      <DataTableHeader
        ...
        callToAction={
          <Button
            ...
            size="md"
            prefix={<PlusIcon />}
            render={<Link href="/app/entitlements/new" />}
          >
