...
import { getColumns } from "~/app/app/pricing-plans/_components/pricing-plans-table-columns"
import { PricingPlansTableToolbarActions } from "~/app/app/pricing-plans/_components/pricing-plans-table-toolbar-actions"
      ...
      <DataTableHeader
        ...
        callToAction={
          <Button
            ...
            variant="primary"
            prefix={<PlusIcon />}
            render={<Link href="/app/pricing-plans/new" />}
          >
            New pricing plan
          </Button>
        }
