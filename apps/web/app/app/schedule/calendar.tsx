      ...
      <Stack size="sm">
        ...
        {!isCurrentMonth && (
          <Button
            ...
            size="md"
            prefix={<CalendarIcon />}
            render={<Link href={`/app/schedule?month=${format(today, "yyyy-MM")}`} />}
          >
            Today
          </Button>
        )}
        ...
        <Button
          ...
          render={<Link href={`/app/schedule?month=${format(subMonths(month, 1), "yyyy-MM")}`} />}
        >
        ...
        <Button
          ...
          render={<Link href={`/app/schedule?month=${format(addMonths(month, 1), "yyyy-MM")}`} />}
        >
