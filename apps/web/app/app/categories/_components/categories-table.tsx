...
import { getColumns } from "~/app/app/categories/_components/categories-table-columns"
import { CategoriesTableToolbarActions } from "~/app/app/categories/_components/categories-table-toolbar-actions"
      ...
      <DataTableHeader
        ...
        callToAction={
          <Button
            ...
            size="md"
            prefix={<PlusIcon />}
            render={<Link href="/app/categories/new" />}
          >
