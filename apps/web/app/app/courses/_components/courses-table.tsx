...
import { getColumns } from "~/app/app/courses/_components/courses-table-columns"
import { CoursesTableToolbarActions } from "~/app/app/courses/_components/courses-table-toolbar-actions"
      ...
      <DataTableHeader
        ...
        callToAction={
          <Button
            ...
            size="md"
            prefix={<PlusIcon />}
            render={<Link href="/app/courses/new" />}
          >
