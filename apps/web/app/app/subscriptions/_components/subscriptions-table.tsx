...
} from "~/app/app/subscriptions/_components/subscriptions-table-columns"
import { SubscriptionsTableToolbarActions } from "~/app/app/subscriptions/_components/subscriptions-table-toolbar-actions"
      ...
      <DataTableHeader
        ...
        callToAction={
          <Button
            ...
            size="md"
            prefix={<PlusIcon />}
            render={<Link href="/app/subscriptions/new" />}
          >
