...
import { getColumns } from "~/app/app/leads/_components/leads-table-columns"
import { LeadsTableToolbarActions } from "~/app/app/leads/_components/leads-table-toolbar-actions"
      ...
      <DataTableHeader
        ...
        callToAction={
          <Button
            ...
            size="md"
            prefix={<PlusIcon />}
            render={<Link href="/app/leads/new" />}
          >
