...
import { getColumns } from "~/app/app/certificates/_components/certificates-table-columns"
import { CertificatesTableToolbarActions } from "~/app/app/certificates/_components/certificates-table-toolbar-actions"
      ...
      <DataTableHeader
        ...
        callToAction={
          <Button
            ...
            size="md"
            prefix={<PlusIcon />}
            render={<Link href="/app/certificates/new" />}
          >
