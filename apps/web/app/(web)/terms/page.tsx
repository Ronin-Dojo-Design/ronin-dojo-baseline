  ...
  return (
    <>
      ...
      <Prose>
        ...
        <h2>1. Agreement</h2>
        <p>
          By creating an account, accessing, or using {siteName} (the "Service") you agree to be
        ...
        <p>
          ...
          behalf of an organization, school, or minor athlete, you represent that you have the
          authority to bind that party to these Terms.
        </p>
        ...
        <ul>
          ...
          <li>
            ...
            <a href={`mailto:${siteConfig.email}`}>{siteConfig.email}</a> if you suspect
        ...
        <ul>
          ...
          <li>
            Interfere with the Service, circumvent rate limits, or attempt unauthorized access.
          </li>
        ...
        <h2>9. Termination</h2>
        <p>
          You may close your account at any time. We may suspend or terminate your access at any
          time for violation of these Terms or for any other reason. Sections that by their nature
          should survive termination (intellectual property, disclaimers, limitation of liability,
        ...
        <p>
          TO THE MAXIMUM EXTENT PERMITTED BY LAW, {siteName.toUpperCase()} SHALL NOT BE LIABLE FOR
          ANY INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL, OR PUNITIVE DAMAGES, OR ANY LOSS OF
          PROFITS OR DATA, ARISING OUT OF OR RELATED TO YOUR USE OF THE SERVICE.
        </p>

        <h2>12. Changes</h2>
        <p>
          We may revise these Terms from time to time. Material changes will be announced on the
          site; continued use after a revision is effective constitutes acceptance.
        </p>
