...
/**
 * The Terms of Service legal copy, kept intact as one coherent document (the section
 * order, headings, and wording — including the all-caps warranty / liability clauses —
 * are load-bearing legal text; do not fragment them). The brand name is interpolated
 * via `siteName`; everything else is static.
 */
export const PolicyBody = ({ siteName }: { siteName: string }) => {
  return (
    <>
      ...
      <p>
        You retain ownership of the content you submit. By submitting content you grant {siteName} a
