  ...
  return (
    <>
      ...
      <Prose>
        ...
        <p>
          Cookies are small text files stored on your device by your browser. They let a site
          remember things across requests — for example, that you are logged in, or that you have a
        ...
        <p>
          ...
          analytics, advertising, retargeting, or social-network cookies. Because everything below
          is strictly necessary to deliver functionality you have explicitly requested (logging in,
        ...
        <table>
          ...
          <tbody>
            <tr>
              ...
              <td>
                Holds your signed authentication session. Without it you cannot stay logged in.
              </td>
        ...
        <p>
          ...
          for aggregate page-view measurement. Plausible is intentionally cookieless. It does not
          set any first- or third-party cookies, does not store cross-site identifiers, and
          anonymizes IP addresses before any data is recorded. Because no personal data is
          collected, no consent is required and no entry appears in the table above.
        </p>
        ...
        <p>
          ...
          identifier, or a third-party analytics tracker that sets cookies), we will publish a
          cookie consent notice before it is set and you will be able to accept or decline before it
          loads.
        </p>
