...
/**
 * Public orchestrator for the Cookies Policy surface. Thin by design: it binds the
 ...
 */
export const CookiesPolicy = ({ brand, siteName, title, description }: PolicyPageProps) => {
  return (
