...
/**
 * `communityGallery` (SESSION_0525 E3) is the live staff-blog card gallery, rendered by
 * the orchestrator and slotted directly below the "Community Feed" promo.
 */
export const BblPromos = ({ communityGallery }: { communityGallery?: ReactNode }) => (
  <>
    {promos.map(promo => (
      <Fragment key={promo.title}>
        ...
        {promo.eyebrow === "Community Feed" && communityGallery}
      </Fragment>
    ))}
  </>
)
