...
/**
 * The Privacy Policy legal copy, kept intact as one coherent document (the section
 * order, headings, and wording are load-bearing legal text — do not fragment them).
 * The brand name is interpolated via `siteName`; everything else is static.
 */
  ...
  return (
    <>
      ...
      <p>
        ...
        personal information transparently. This Privacy Policy explains what we collect, how we use
      ...
      <ul>
        ...
        <li>
          Membership and registration data for the organizations, schools, and tournaments you join.
        </li>
        <li>
      ...
      <p>
        We do not sell your personal information. We share information in only these circumstances:
      </p>
      <ul>
        <li>
          <strong>Service providers we rely on</strong> to operate {siteName}: Stripe (payments and
          subscription billing), Plausible Analytics (aggregate traffic measurement), Neon (managed
          PostgreSQL database), Vercel (hosting and edge delivery), and Resend or a comparable
          provider for transactional email. Each provider is bound by its own data processing terms.
        </li>
        <li>
          <strong>Publicly displayed profile content</strong> you have chosen to make public on your
          directory profile, school listing, or lineage entry.
        </li>
        <li>
      ...
      <p>
        ...
        be signed in) to submit a request. We acknowledge requests promptly and aim to fulfill them
        within thirty (30) days. We may verify the request by relying on your authenticated session.
      </p>
      ...
      <p>
        ...
        service providers operate, which may have different data protection rules than your country
        of residence.
      </p>
