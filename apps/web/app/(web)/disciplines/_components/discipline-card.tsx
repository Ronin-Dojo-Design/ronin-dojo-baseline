        ...
        <CardHeader>
          <Stack size="sm" direction="column">
            <Stack size="sm">
              ...
              {discipline.code && (
                <Badge variant="outline" size="sm">{discipline.code}</Badge>
              )}
            </Stack>

            <Stack size="xs" className="text-sm text-muted-foreground">
              <span>{discipline._count.rankSystems} rank system{discipline._count.rankSystems !== 1 ? "s" : ""}</span>
              <span>·</span>
              <span>{discipline._count.organizations} org{discipline._count.organizations !== 1 ? "s" : ""}</span>
              <span>·</span>
