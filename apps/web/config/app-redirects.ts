const MIGRATED_ADMIN_APP_ROUTES = [
  ...
  { source: "/admin/posts", destination: "/app/blog" },
  { source: "/admin/posts/:path*", destination: "/app/blog/:path*" },
  ...
  { source: "/admin/task-board", destination: "/app/loop-board" },
  { source: "/admin/techniques", destination: "/app/techniques" },
  { source: "/admin/techniques/:path*", destination: "/app/techniques/:path*" },
  { source: "/admin/billing", destination: "/app/billing" },
  { source: "/admin/billing/:path*", destination: "/app/billing/:path*" },
  { source: "/admin/categories", destination: "/app/categories" },
  { source: "/admin/categories/:path*", destination: "/app/categories/:path*" },
  { source: "/admin/tags", destination: "/app/tags" },
  { source: "/admin/tags/:path*", destination: "/app/tags/:path*" },
  { source: "/admin/pricing-plans", destination: "/app/pricing-plans" },
  { source: "/admin/pricing-plans/:path*", destination: "/app/pricing-plans/:path*" },
  { source: "/admin/subscription-tiers", destination: "/app/subscription-tiers" },
  { source: "/admin/subscription-tiers/:path*", destination: "/app/subscription-tiers/:path*" },
  { source: "/admin/subscriptions", destination: "/app/subscriptions" },
  { source: "/admin/subscriptions/:path*", destination: "/app/subscriptions/:path*" },
  { source: "/admin/merch", destination: "/app/merch" },
  { source: "/admin/merch/:path*", destination: "/app/merch/:path*" },
  { source: "/admin/tools", destination: "/app/tools" },
  { source: "/admin/tools/:path*", destination: "/app/tools/:path*" },
  { source: "/admin/storage", destination: "/app/storage" },
  { source: "/admin/storage/:path*", destination: "/app/storage/:path*" },
  { source: "/admin/repo-docs", destination: "/app/repo-docs" },
  { source: "/admin/repo-docs/:path*", destination: "/app/repo-docs/:path*" },
] as const
