  ...
  it("redirects only admin areas with existing /app equivalents", () => {
    expect(buildMigratedAdminAppRedirects()).toEqual([
      ...
      { source: "/admin/categories", destination: "/app/categories", permanent: true },
      {
        ...
        destination: "/app/categories/:path*",
        permanent: true,
      },
      ...
      {
        source: "/admin/pricing-plans/:path*",
        destination: "/app/pricing-plans/:path*",
        permanent: true,
      },
      {
        source: "/admin/subscription-tiers",
        destination: "/app/subscription-tiers",
        permanent: true,
      },
      {
        source: "/admin/subscription-tiers/:path*",
        destination: "/app/subscription-tiers/:path*",
        permanent: true,
      },
      { source: "/admin/subscriptions", destination: "/app/subscriptions", permanent: true },
      {
        source: "/admin/subscriptions/:path*",
        destination: "/app/subscriptions/:path*",
        permanent: true,
      },
