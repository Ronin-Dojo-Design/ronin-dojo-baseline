...
> **Repo scope (RDD-local preamble — D11, Obsidian Dashboard Epic §7; not upstream).**
...
> pattern): before any design output for a brand surface, read that brand's seed tokens +
> the relevant canon doc — design skills are context-gated, not free-running.
> Vendored as-is from [Nutlope/hallmark](https://github.com/Nutlope/hallmark) v1.1.0 (MIT,
> LICENSE retained); everything below this block is upstream text.
